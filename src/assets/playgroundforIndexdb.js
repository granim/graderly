...
//   let course = {}
//   try {
//      course = await db.collection('courses').doc({courseId: data.courseId})
//       .get()
...
//      course.courseStudents.push({id: student.id, name: student.name})
//  })     
//  db.collection('courses').doc({courseId: data.courseId}).update()  
