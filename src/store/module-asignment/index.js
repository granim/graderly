...
export default {
  ...
  state() {
    return {
      ...
      //list of possible subject users can select from when creating a class
      //  'calculate', 'science','create', 'auto_stories', 'terrain', 'record_voice_over', 'spellcheck','travel_explore'
      allSubjects: [
        {
          id: "s1",
          name: "Math",
        ...
        },
        {
          ...
          label: "Writing",
          value: "Writing",
          description: "Writing/Penmanship",
          icon: "create"
        },
        {
          id: "s4",
        ...
        },
        {
          ...
          description: "Social studies subject",
          icon: "travel_explore"
        },
        {
          id: "s9",
      ...
      //Make asignments and array of arrays
      // allasignments [[course x asignments], [course y asignments ]]
      allAsignments: []
    };
  },
  getters,
